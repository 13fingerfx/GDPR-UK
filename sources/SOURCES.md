...
Every file in this directory was inspected and verified on 16 July 2026. Skills should treat these as the primary sources and cite them by the names below.

## Legislation

| File | What it is | Coverage verified |
|---|---|---|
...
| File | What it is | Coverage verified |
|---|---|---|
| `ico-guide-to-data-protection-exemptions.pdf` | ICO Guide to the DPA 2018 Schedule 2–4 exemptions | Complete — 29 pages |
| `ico-right-of-access.pdf` | ICO detailed Right of Access (DSAR) guidance, v1.0.87, 8 Dec 2025 | Complete — 124 pages |
| `ico-breach-assessing-guide.pdf` | ICO Guide to assessing personal data breaches | Complete — 15 pages |
| `ico-dpia-high-risk-list.pdf` | ICO examples of processing "likely to result in high risk" (DPIA triggers) | Complete — webpage capture with the full list |
| `ico-dpia-template.docx` | ICO Sample DPIA template (Steps 1–7) | Complete — official template; basis for `templates/dpia.md` |
...
- `uk-gdpr-latest-available.pdf` / `-fuller.pdf` — legislation.gov.uk **amendment changelogs only** (lists of textual substitutions by S.I. 2026/386), no regulation text.
